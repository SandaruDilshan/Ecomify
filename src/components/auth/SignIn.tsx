...
const SignIn = ({ action }: SignInProps) => {
    ...
    return (
        <Form action={formAction} className='max-w-md mx-auto my-16 p-8 bg-white rounded-lg shadow-md'>
            <h1 className='text-2xl font-bold text-center mb-2'>Welcom Back</h1>
            <p className='text-center text-sm text-rose-600 font-semibold mb-2'>🔥 MEMBER EXCLUSIVE 🔥</p>
            <p className='text-center text-sm text-gray-600 mb-6'>Sign in to your exclusive member deals.</p>
            ...
            <div className='space-y-6'>
                ...
                <div className='text-center'>
                    <p className='text-xs text-gray-500 mb-2'>⚡️ Menber save an extra 15% on all orders !</p>
